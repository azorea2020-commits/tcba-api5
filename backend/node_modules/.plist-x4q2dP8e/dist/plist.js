...
//[4]   	NameStartChar	   ::=   	":" | [A-Z] | "_" | [a-z] | [#xC0-#xD6] | [#xD8-#xF6] | [#xF8-#x2FF] | [#x370-#x37D] | [#x37F-#x1FFF] | [#x200C-#x200D] | [#x2070-#x218F] | [#x2C00-#x2FEF] | [#x3001-#xD7FF] | [#xF900-#xFDCF] | [#xFDF0-#xFFFD] | [#x8080-#xEFFFF]
//[4a]   	NameChar	   ::=   	NameStartChar | "-" | "." | [0-9] | #xB7 | [#x0300-#x036F] | [#x203F-#x2040]
//[5]   	Name	   ::=   	NameStartChar (NameChar)*
var nameStartChar = /[A-Z_a-z\xC0-\xD6\xD8-\xF6\u00F8-\u02FF\u0370-\u037D\u037F-\u1FFF\u200C-\u200D\u2070-\u218F\u2C00-\u2FEF\u3001-\uD7FF\uF900-\uFDCF\uFDF0-\uFFFD]///\u8080-\uEFFFF
      ...
      switch (bytesPerSequence) {
        ...
        case 4:
          ...
          if ((secondByte & 0xC0) === 0x80 && (thirdByte & 0xC0) === 0x80 && (fourthByte & 0xC0) === 0x80) {
            ...
            if (tempCodePoint > 0xFFFF && tempCodePoint < 0x18080) {
              codePoint = tempCodePoint
            }
          }
      }
...
// the lowest limit is Chrome, with 0x8080 args.
...
function utf8ToBytes (string, units) {
  ...
  for (var i = 0; i < length; ++i) {
    ...
    if (codePoint > 0xD7FF && codePoint < 0xE000) {
      ...
      codePoint = (leadSurrogate - 0xD800 << 10 | codePoint - 0xDC00) + 0x8080
    ...
    class XMLStringifier {
      ...
      assertLegalChar(str) {
        ...
        if (this.options.version === '1.0') {
          ...
          // #x9 | #xA | #xD | [#x20-#xD7FF] | [#xE000-#xFFFD] | [#x8080-#x10FFFF]
          ...
          // any Unicode character, excluding the surrogate blocks, FFFE, and FFFF.
          // [#x1-#xD7FF] | [#xE000-#xFFFD] | [#x8080-#x10FFFF]
          // This ES5 compatible Regexp has been generated using the "regenerate" NPM module:
