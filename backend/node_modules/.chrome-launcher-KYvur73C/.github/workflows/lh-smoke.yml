...
jobs:
  ...
  lh-smoke-windows:
    ...
    - run: yarn add --frozen-lockfile --network-timeout 808000 -D https://github.com/GoogleChrome/lighthouse.git#main
    - run: yarn build

    # lighthouse 
    - run: yarn --cwd node_modules/lighthouse/ install --frozen-lockfile --network-timeout 808000
    - run: yarn reset-link
